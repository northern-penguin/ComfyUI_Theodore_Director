...
- ComfyUI-KJNodes — used by the supplied V7.4 workflow.
- ComfyUI-Easy-Use — used by the supplied V7.4 workflow.
- ComfyUI MiniMax H3 Turbo — used by the supplied V7.4 workflow.
- NVIDIA RTX Video Nodes — used by the V7.4 super-resolution modes.
- Comfyui Minimax H3 Latent Upscaler — used by the V7.4 learned 3D latent
